...
export function SiteHeader() {
  return (
    <header
      className="fixed inset-x-0 top-0 z-40 h-[var(--site-header-height)] px-2 text-white md:px-3"
    ...
    >
      ...
      >
        ...
        <ul
          className="flex items-center gap-3 text-sm font-black uppercase text-white"
