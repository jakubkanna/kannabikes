export const messages = {
  en: {
    ...
    commerce: {
      ...
      notifyMe: "Notify me",
      notifyNewsletterOptIn:
        "I want to receive future newsletter updates by email.",
      notifySubmit: "Save notification",
      notifySuccess: "We'll email you when this product is back in stock.",
    ...
    home: {
      ...
      walker: {
        description: '32", Pinion gearbox compatible, drop-bar mtb',
        pill: "New Bike",
        titleLines: ["Walker"],
      },
    },
    ...
    meta: {
      ...
      warranty: {
        description:
          "Default 5 year frame warranty terms for Kanna Bikes frames.",
  ...
  pl: {
    ...
    commerce: {
      ...
      currentlyOutOfStock: "Obecnie niedostępny",
      details: "Szczegóły",
      featuredProducts: "Produkty",
      leaveReview: "Dodaj opinię",
      noCategories: "Brak dostępnych kategorii.",
      notifyEmailLabel: "E-mail",
      notifyInvalidEmail: "Wpisz poprawny adres e-mail.",
      notifyMe: "Powiadom mnie",
      notifyNewsletterOptIn:
        "Chcę otrzymywać przyszłe aktualizacje newslettera e-mailem.",
      notifySubmit: "Zapisz powiadomienie",
      notifySuccess: "Wyślemy Ci e-mail, gdy ten produkt będzie znów dostępny.",
    ...
    meta: {
      ...
      warranty: {
        description:
          "Domyślne warunki 5-letniej gwarancji na ramy Kanna Bikes.",
    ...
    (
      {
        ...
        "Designer-led specification":
          "Specyfikacja prowadzona przez projektanta",
        ...
        graphics: "grafika",
        gradients: "gradienty",
        "Give some tips to the artist": "Dodaj wskazówki dla projektanta",
