export const messages = {
  en: {
    ...
    commerce: {
      ...
      reviews: "Reviews",
      reviewsLoadError:
        "We could not load the product reviews right now.",
  ...
  pl: {
    account: {
      ...
      profileTitle: "Profil",
      ratingLabel: "Ocena",
      registrationSuccess: "Konto zostało utworzone. Przekierowujemy do Twojego konta...",
    ...
    commerce: {
      ...
      reviews: "Opinie",
      reviewsLoadError:
        "Nie udało się teraz załadować opinii o produkcie.",
